...
summary: En este artículo comparto algunos consejos para configurar Internet a través de un proxy global en los sistemas operativos GNU/Linux.
date: 2020-12-06
...
En los sistemas operativos GNU/Linux es complicado acceder a internet a través de un proxy. Muchas de las distribuciones GNU/Linux utilizan diferentes administradores de paquetes que se configuran de diferentes formas, además hay muchos programas que necesitan sus especificaciones para configurar la salida de Internet a través de un servidor proxy. Todo este proceso se vuelve muy engorroso de hacer en entornos donde usas un proxy con autenticación y cambia la autenticación cada cierto tiempo o usas un portátil donde puedes configurar un proxy para una red, pero que tengas que cambiar esa configuración en otra red. Imagina cambiar todas las configuraciones cada vez que cambias de red.

![Proxy schema](../images/configure-proxy-global-on-linux/proxy-schema.png "Configurar proxy en linux")
