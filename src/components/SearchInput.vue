...
export default class SearchInput extends Vue {
  ...
  get allPost() {
    //@ts-ignore
    return this.$static.allPost;
  }

  get allDocumentation() {
    //@ts-ignore
    return this.$static.allDocumentation;
  }

  get pages() {
    let result = [];
    const allPost = this.allPost.edges.map(edge => edge.node);
    ...
    const allDocs = this.allDocumentation.edges.map(edge => edge.node);
