<template>
  <div class="text-lightest-slate hover:text-gray-600 cursor-pointer" @click.prevent="$store.commit('toggleTheme')" data-cypress="switchTheme">
...
export default class ThemeSwitcher extends Vue {
  get theme(): string {return this.$store.state.theme}
}
</script>
